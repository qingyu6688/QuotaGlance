...
当前 0.1.0 已完成上述第 1～5 步的首轮实现，并在 Windows 上通过 Codex 桌面应用受管运行副本完成真实账号只读 POC。合法 bundled sidecar、固定版本兼容范围、完整认证矩阵、更新和双平台生产适配仍需继续实施与验证。
